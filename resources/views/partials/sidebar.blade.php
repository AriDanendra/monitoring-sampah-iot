    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <li class="{{ request()->is('monitoring') ? 'active' : '' }}">
                <a href="{{ route('monitoring') }}"><i class="fa-solid fa-map-location-dot"></i> Monitoring</a>
            </li>
            <li class="{{ request()->is('riwayat') ? 'active' : '' }}">
                <a href="{{ route('riwayat') }}"><i class="fa-solid fa-clock-rotate-left"></i> Riwayat</a>
            </li>
            <li class="{{ request()->is('pengaturan') ? 'active' : '' }}">
                <a href="{{ route('pengaturan') }}"><i class="fa-solid fa-gear"></i> Pengaturan</a>
            </li>
